                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-5">
                                                    ...
                                                    <textarea class="form-control form-control-sm" id="remarks" name="remarks" rows="2" placeholder="Remarks"
                                                        tabindex="2"></textarea>
                                                                ...
                                                                <tfoot>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-right: none;"><input readonly
                                                                                type="number" onkeyup="calculation()"
                                                                                value="0" class="form-control"
                                                                                id="total_item" name="total_item"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-2">
                                                                ...
                                                                <input type="number" readonly
                                                                    class="form-control form-control-sm" id="r_amount"
