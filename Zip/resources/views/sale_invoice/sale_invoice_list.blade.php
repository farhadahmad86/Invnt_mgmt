                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('sale_invoice.index') }}" method="get">
                                ...
                                <div class="row">
                                    ...
                                    <x-datefilter label="From" id="from_date" name="from_date" value="{{$from_date}}"/>
                                    <x-datefilter label="To" id="to_date" name="to_date" value="{{$to_date}}"/>
                                    ...
                                    <div class="col-0-5">
                                        ...
                                        <div class="form-group">
                                            <a href="{{route('sale_invoice.index')}}" class="btn btn-primary btn-sm" id="">
                                                Clear
                                            </a>
                                        </div>
                                    </div>
