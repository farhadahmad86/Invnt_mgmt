            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        ...
                        <p class="mb-1">job_delivery</p>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Job Management</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">job_delivery</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Create job_delivery</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form job_delivery</h4>
                        </div>
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" id="form" action="{{ route('job_delivery_update') }}"
                                    method="post">
                                    @csrf
                                    <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="delivered" name="delivered" checked>
                                                    </div>
                                                </div>
                                            </div>
                                                <div class="form-group row">
