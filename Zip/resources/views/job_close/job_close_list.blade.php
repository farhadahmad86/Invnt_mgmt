                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('job_close.index') }}" method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-0-5">
                                        ...
                                        <div class="form-group">
                                            <a href="{{ route('job_close.index') }}" class="btn btn-primary btn-sm"
                                                id="">
                                                Clear
                                            </a>
                                        </div>
                            ...
                            {{ $query->appends(['segmentSr' => $countSeg, 'job_no' => $job_no, 'from_date' => $from_date, 'to_date' => $to_date, 'status' => $status])->links() }}
                        </div>
                    </div>
                </div>
            </div>
