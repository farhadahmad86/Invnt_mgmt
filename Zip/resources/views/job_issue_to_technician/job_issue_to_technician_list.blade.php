            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        ...
                        <p class="mb-1">Job Assign To Technician List</p>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Job Management</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Job Assign To Technician</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Job Assign To Technician List</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Job Assign To Technician List</h4>
                            <!-- Ibrahim add -->
                            {{--                        <button > --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-0-5">
                                        ...
                                        <div class="form-group">
                                            <a href="{{route('job_issue_to_technician.index')}}" class="btn btn-primary btn-sm" id="">
                                                Clear
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($query as $job_issue_to_technician)
                                            <tr>
                                                ...
                                                <td>{{ date('d-m-Y', strtotime($job_issue_to_technician->jitt_created_at)) }}
                                                </td>
