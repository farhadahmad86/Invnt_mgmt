                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-1-5">
                                        ...
                                        <select id="login_status" name="login_status">
                                            ...
                                            <option value="1"
                                            {{$login_status == '1' ? 'selected' : ''}}>Yes</option>
                                            <option value="0"
                                            {{$login_status == '0' ? 'selected' : ''}}>No</option>
                                    ...
                                    <div class=" col-1-5">
                                        ...
                                        <select id="emp_status" name="emp_status">
                                            ...
                                            <option value="" selected disabled>Select Status</option>
                                            <option value="1"
                                            {{$emp_status == '1' ? 'selected' : ''}}>Yes</option>
                                            <option value="0"
                                            {{$emp_status == '0' ? 'selected' : ''}}>No</option>
                                    ...
                                    <div class=" col-1-5">
                                        ...
                                        <select id="tech_status" name="tech_status">
                                            ...
                                            <option value="" selected disabled>Select Status</option>
                                            <option value="1"
                                            {{$tech_status == '1' ? 'selected' : ''}}>Yes</option>
                                            <option value="0"
                                            {{$tech_status == '0' ? 'selected' : ''}}>No</option>
                                    ...
                                    <div class="col-0-5">
                                        <div class="form-group">
                                            <a href="{{route('employee_registration.index')}}" class="btn btn-primary btn-sm" id="">
                                                Clear
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($query as $employee_registration)
                                            <tr>
                                                ...
                                                <td>{{ $employee_registration->work_status == 1 ? 'Yes' : 'No' }}</td>
