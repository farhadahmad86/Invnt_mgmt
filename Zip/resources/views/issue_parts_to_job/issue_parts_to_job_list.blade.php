            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        ...
                        <p class="mb-1">Issue Parts For Jobs List</p>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Job Management</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Issue Parts To Jobs</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Issue Parts For Jobs
                                List</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Issue Parts For Jobs List</h4>
                            <!-- Ibrahim add -->
                            {{--                        <button > --}}
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('issue_parts_to_job.index') }}" method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-1-0">
                                        <div class="form-group mb-0">
                                            <label for="">Issue Against Damage</label>
                                    ...
                                    <div class="col-0-5">
                                        ...
                                        <div class="form-group">
                                            <a href="{{ route('issue_parts_to_job.index') }}" class="btn btn-primary btn-sm"
                                                id="">
                                                Clear
                                            </a>
                                        </div>
                            ...
                            {{ $query->appends(['segmentSr' => $countSeg, 'job_no' => $job_no, 'inv_no' => $inv_no, 'status' => $status, 'from_date' => $from_date, 'to_date' => $to_date, 'damage' => $damage])->links() }}
                        </div>
                    </div>
                </div>
            </div>
