                            ...
                            <form action="{{ route('job_hold.index') }}" method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-0-5">
                                        ...
                                        <div class="form-group">
                                            <a href="{{ route('job_hold.index') }}" class="btn btn-primary btn-sm"
                                                id="">
                                                Clear
                                            </a>
                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($query as $brand)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($brand->jh_updated_at == null)
                                                    <a href="{{route('job_hold_status',$brand->jh_id)}}" class="btn btn-primary">Change Status</a>
                                                    @else
                                                        {{"Assigned"}}
                                                    @endif
                                                </td>
