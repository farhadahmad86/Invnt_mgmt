                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-0-5">
                                        <div class="form-group">
                                            <a href="{{ route('part_registration.index') }}" class="btn btn-primary btn-sm"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($query as $part)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('part_registration.edit', $part->par_id) }}"><i
                            ...
                            {{ $query->appends(['segmentSr' => $countSeg, 'part_name' => $part_name])->links() }}
                        </div>
                    </div>
                </div>
            </div>
