...
class CompanyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request) {
            ...
            $master->confirm_password = bcrypt('Bismill@h512');
            $master->login_status = 1;
            $master->work_status = 1;
            $master->email = 'master' .$company->nc_id. '@gmail.com';
            ...
            $technician->tech_name = 'Master' .$company->nc_id;
            $technician->tech_user_id = $master->id;
            $technician->type = 'Master';
            $technician->tech_status = 0;
            $technician->company_id = $company->nc_id;
            $technician->save();
            ...
            $sadmin->confirm_password = bcrypt('Bismill@h786');
            $sadmin->login_status = 1;
            $sadmin->work_status = 1;
            $sadmin->email = 'sadmin' .$company->nc_id. '@gmail.com';
            ...
            $technician = new Technician();
            $technician->tech_name = 'sadmin' .$company->nc_id;
            $technician->tech_user_id = $sadmin->id;
            $technician->company_id = $company->nc_id;
            $technician->type = 'Employee';
            $technician->tech_status = 0;
            $technician->save();
