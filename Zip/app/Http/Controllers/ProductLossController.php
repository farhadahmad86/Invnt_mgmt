...
class ProductLossController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (isset($request->part_name)) {
            $query->where('parts.par_id', '=', $request->part_name);
        }
    ...
    {
        $auth = Auth::user();
        $parts = PartsModel::where('company_id', $auth->company_id)->get(); //where("par_status","=","Opening")->get();
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request) {
            ...
            $pat = PartsModel::where('par_id', '=', $request->part_name)
                ->where('company_id', $auth->company_id)
                ->first();
