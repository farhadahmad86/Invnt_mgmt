...
{
    //parts_issue_modal
    public function parts_issue_modal_view_details(Request $request)
    {
        $auth = Auth::user();
        // dd(2);
    ...
    public function parts_issue_modal_view_details_SH(Request $request, $id)
    {
        // dd(2);
        $auth = Auth::user();
    ...
    public function parts_issue_modal_view_details_pdf_SH(Request $request, $id)
    {
    ...
    public function parts_return_modal_view_details(Request $request)
    {
        $auth = Auth::user();
        // dd(2);
        $items = IssuePartsToJobItemsModel::where('iptji_id', $request->id)
    ...
    public function parts_return_modal_view_details_SH(Request $request, $id)
    {
        // dd(2);
        $auth = Auth::user();
        $items = DB::table('issue_parts_to_job_items')
    ...
    public function parts_return_modal_view_details_pdf_SH(Request $request, $id)
    {
        // $sim = DB::table('financials_sale_invoice')
        //     ->join('financials_accounts', 'financials_accounts.account_uid', '=', 'financials_sale_invoice.si_party_code')
        //     ->where('si_id', $id)
    ...
    public function part_return_modal_view_details_SH(Request $request, $id)
    {
        ...
        $items = DB::table('issue_parts_to_job')
